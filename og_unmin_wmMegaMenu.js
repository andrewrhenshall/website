...
class wmMegaMenu {
    ...
    openMenu(e) {
        ...
        const t = this.menu.animate(this.getOpenAnimationKeyframes(), {
    ...
    closeMenu() {
        ...
        if (((this.isAnimating = !0), this.runHooks("beforeCloseMenu"), !this.isMenuOpen))
            return void (this.isAnimating = !1);
        const e = this.menu.animate(this.getCloseAnimationKeyframes(), {
        ...
        this.handleArrowAnimation("close"),
            (e.onfinish = () => {
                this.menu.classList.remove("open"),
                    ...
                    (this.isMenuOpen = !1),
                    (this.isAnimating = !1),
                    "inset" !== this.settings.layout && this.revertColorTheme(),
                    this.menus.forEach((e) => {
                        e.desktopTriggers.forEach((e) => e.parentElement.classList.remove("mega-menu--active")),
                            e.item.classList.remove("active");
                    }),
        ...
        const t = this.arrow,
            i = () => {
                const e = this.arrow,
                    ...
                    s = i.desktopTriggers[0].getBoundingClientRect();
                (this.arrowX = s.left + s.width / 2 - e.offsetWidth / 2), (this.arrowY = n.top - e.offsetHeight / 2);
            };
        return "open" === e
            ? (i(),
            ...
            : "move" === e
              ? (i(),
                t.animate([{ left: `${this.arrowX}px`, top: `${this.arrowY}px` }], {
                    duration: 300,
                    easing: "ease",
                    fill: "forwards",
                }))
    ...
    positionMenuWrapper() {
        ...
        this.menu.style.setProperty("--active-menu-height", t + "px"),
            ...
            requestAnimationFrame(() => {
                this.absoluteMenu.style.transform = `translateX(-${e}px)`;
            });
    }
    parseInsetLimit(e) {
    ...
    handleInsetMenuPositioning(e = !1) {
        ...
        const l = window.getComputedStyle(this.menuWrapper).transform,
            d = ("none" !== l && parseFloat(l.split(",")[4]), `translateX(${o}px)`);
        (this.menuWrapper.style.transform = d),
            this.setSizing(),
            e &&
                (this.menuWrapper.offsetHeight,
                setTimeout(() => {
